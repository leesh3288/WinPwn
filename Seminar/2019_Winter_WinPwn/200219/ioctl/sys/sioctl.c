...
extern void inline PrivEsc(PVOID);
...

{
    ...
    case IOCTL_SIOCTL_METHOD_NEITHER:
        ...
        try
        {
            ProbeForRead(inBuf, copyLen, sizeof(CHAR));
            ProbeForWrite(outBuf, copyLen, sizeof(CHAR));
        }
        except(EXCEPTION_EXECUTE_HANDLER)
        {
            ...
            SIOCTL_KDPRINT((
                "Exception while accessing buffer 0X%08X in METHOD_NEITHER\n",
                ntStatus));
            break;
        }
